...
MAC_shellK = [7.5310 for i in range(240)]
EabsK = [1.2638 for i in range(240)]

print(MAC_coreK[0])
print(max(MAC_core))
print(min(MAC_core))
print(sum(MAC_core[48:])/len(MAC_core[48:]))
print(MAC_shellK[0])
print(max(MAC_shell))
print(min(MAC_shell))
print(sum(MAC_shell[48:])/len(MAC_shell[48:]))
print(EabsK[0])
print(max(Eabs_list))
print(min(Eabs_list))
print(sum(Eabs_list[48:])/len(Eabs_list[48:]))
