...
def nDp_to_filtered_nD(nDp,timeafter=96):
    ...
    return norm_nDp
mean_CT_bin = 0
norm_nCT = nDp_to_filtered_nD(nCT,timeafter=96)

norm_nCT10_40nm = nDp_to_filtered_nD(nCT10_40nm,timeafter=96)
norm_nCT40_70nm = nDp_to_filtered_nD(nCT40_70nm,timeafter=96)
norm_nCT70_100nm = nDp_to_filtered_nD(nCT70_100nm,timeafter=96)
norm_nCT100_130nm = nDp_to_filtered_nD(nCT100_130nm,timeafter=96)
...
ax.text(200,-1.5,'k = '+str(abs(round(k,3))),fontsize=9,horizontalalignment='left', verticalalignment='center')
ax.text(200,-2.5,'$\mathrm{R^2}$ = '+str(abs(round(R_2,3))),fontsize=9,horizontalalignment='left', verticalalignment='center')
ax.set_xlim([0,300])
ax.set_ylim([-14,0])
